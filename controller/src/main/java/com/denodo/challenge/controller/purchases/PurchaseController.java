...
public class PurchaseController {
    ...
    public Response totalPurchasesForMostRepeatedAgeByDate(
            @RequestParam @NotNull @DateTimeFormat(pattern = DATE_FORMAT) LocalDateTime initDateTime,
            @RequestParam @NotNull @DateTimeFormat(pattern = DATE_FORMAT) LocalDateTime endDateTime) throws Exception {
            ...
            return ResponseEntityHandler.getOkMessage(result, Response.Status.OK);
    }
